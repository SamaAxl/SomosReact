...
//renderiza la cabecera de la pagina y sus iconos
const handleKeyPress = (event) => {
  if (event.charCode === 13) return alert("No se encontraron resultados :(");
};
  ...
  return (
    <section className="header">
      <div className="header-content container">
        <a href="#">
          <img
            src="https://media.discordapp.net/attachments/737869974013476906/982792066750902292/unknown.png"
            alt="Instagram Logo"
          />
        </a>
        <input
